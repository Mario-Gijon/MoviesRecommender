...
from app.project_paths.dataset_paths import CONTENT_BASED_RECOMMENDER_MODELS_DIR, OFFLINE_DATASET_CSV_DIR

PUBLIC_MOVIES_CSV_PATH = OFFLINE_DATASET_CSV_DIR / "public_movies.csv"
CONTENT_BASED_OUTPUT_DIR = CONTENT_BASED_RECOMMENDER_MODELS_DIR
...
MAX_RATING = 5
NEUTRAL_RATING = 3
MINIMUM_REQUIRED_NON_NEUTRAL_RATINGS = 3
RECOMMENDED_MINIMUM_RATINGS = 8
...
EXPLANATION_SIGNAL_LIMIT = 6
EXPLANATION_REASON_LIMIT = 3
SIMILAR_RATED_MOVIE_LIMIT = 2
DEFAULT_TEMPLATE_SELECTION_SEED = "default"
